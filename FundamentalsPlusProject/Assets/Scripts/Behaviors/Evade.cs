...
{
    //SAME AS PURSUE, BESIDES LINE 44
    ...
    protected override Vector3 getTargetPosition()
    {
        ...
        //originally return target.transform.position + myMovingTarget.linearVelocity * predictionTime;
        // changed to characters position to go away from
    }
}
